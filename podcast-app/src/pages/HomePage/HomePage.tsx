    ...
    return (
        <div className='w-100 m-10'>
            ...
            <div className='mb-28 w-full flex justify-end items-center'>
                ...
                <input name='filter-input' onChange={(e) => filterPodcasts(e)} type='text' placeholder='Search for podcasts' className='w-1/2 p-2 rounded-lg border-2 border-gray-300 focus:outline-none focus:border-blue-500' />
            </div>
